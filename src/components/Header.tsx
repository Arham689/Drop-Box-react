		...
		<nav className='fixed top-14 w-full h-24 p-6 flex justify-between font-inner '>
			<section className='flex justify-center items-center text-sm font-semibold '>
				...
				<div className=' group px-3 flex justify-center items-center gap-0.5 cursor-pointer relative '>
					...
					<div
						className='absolute left-0 top-10 w-[800px] transition group-hover:translate-y-5 translate-y-0 opacity-0 invisible group-hover:opacity-100  group-hover:visible 
				...
				<div className='group px-3 flex justify-center items-center gap-0.5 cursor-pointer relative '>
					...
					>
						...
						<div className='grid grid-cols-3 '>
							<div className=' list-none text-[gray] flex flex-col gap-2 '>
								Teams
								<li className='text-black py-2 pr-2 hover:bg-amber-50 rounded-lg w-[70%] text-[14px] font-medium  '>
									Sales
								</li>
								<li className='text-black py-2 pr-2 hover:bg-amber-50 rounded-lg w-[70%] text-[14px] font-medium  '>
									Marketing
							...
							<div className=' list-none text-[gray] flex flex-col gap-2 '>
								Use case
								<li className='text-black py-2 pr-2 hover:bg-amber-50 rounded-lg w-[70%] text-[16px] font-medium  '>
									Cloud Storage
								</li>
								<li className='text-black py-2 pr-2 hover:bg-amber-50 rounded-lg w-[70%] text-[16px] font-medium  '>
									Sent Large filse
							...
							<div className=' list-none text-[gray] flex flex-col gap-2 pb-3'>
								Industries
								<li className='text-black py-2 pr-2 hover:bg-amber-50 rounded-lg w-[70%] text-[16px] font-medium  '>
									Construction{' '}
								</li>
				...
				<div className='px-3 cursor-pointer hover:text-button-blue '>
					Enterprise
				</div>
				<div className='px-3 cursor-pointer hover:text-button-blue '>
					Pricing
			...
			<section className='flex justify-center items-center text-sm  '>
				...
				<div className='pl-3 text-[16px] font-semibold'>
					<button className='bg-button-blue text-white rounded-xl px-3 h-10'>
						Get started
					</button>
				</div>
			</section>
